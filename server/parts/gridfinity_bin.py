...
class GridfinityBinDefinition(BaseModel):
    ...
    gridz_define: Annotated[Literal[0, 1, 2, 3], Field(description="How gridz calculates height")] = 0
    ...
    style_tab: Annotated[Literal[0, 1, 2, 3, 4, 5], Field(description="Tab style")] = 5
    place_tab: Annotated[Literal[0, 1], Field(description="Tab placement")] = 0
...
async def gridfinity_bin(request: Request, body: GridfinityBinDefinition):
    ...
    return response.raw(
        await build(
            ...
            bin_gridz_define=body.gridz_define,
            ...
            bin_style_tab=body.style_tab,
            bin_place_tab=body.place_tab,
